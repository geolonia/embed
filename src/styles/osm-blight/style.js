export default apiKey => ({
  ...
  sources: {
    openmaptiles: {
      type: 'vector',
      url: `https://api.tilecloud.io/v1/sources?key=${apiKey}`,
    },
    'japanese-prefectures': {
      type: 'geojson',
      data: 'https://api.tilecloud.io/v1/prefs',
    },
  },
  sprite: 'https://styles.tilecloud.io/osm-bright/sprite',
  glyphs: 'https://glyphs.tilecloud.io/{fontstack}/{range}.pbf',
  layers: [
    {
      id: 'background',
      type: 'background',
    ...
    {
      id: 'japanese-prefectures-label',
      type: 'symbol',
      minzoom: 0,
      maxzoom: 9,
      source: 'japanese-prefectures',
      paint: {
        'text-color': '#000000',
        'text-halo-color': '#ffffff',
        'text-halo-width': 2,
